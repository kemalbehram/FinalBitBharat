...
import com.mobiloitte.p2p.content.dto.BankDto;
...
public interface UserClient {
	...
	@GetMapping("/get-bank-data")
	public Response<BankDto> getBankData(@RequestParam String bankName, @RequestParam Long userId);
