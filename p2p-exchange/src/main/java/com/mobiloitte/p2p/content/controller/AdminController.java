...
public class AdminController implements OtherConstants {
	...
	public Response<Map<String, Object>> getOpenTradeDetails(@RequestHeader Long userId,
			...
			@RequestParam(required = false, value = "pageSize") Integer pageSize, @RequestParam(required = false) Long toDate) {

		return createAdvertisementService.getOpenTradeDetails(userId, page,fromDate,coin,orderType, pageSize,toDate);
	...
	@GetMapping("/Escrow-List")
	public Response<Object> escrowList(@RequestHeader Long userId, Integer page, Integer pageSize,
		...
		return adminService.escrowList(userId, page, pageSize, tradingPartner,statusType,coinName,transactionStatus);
	}
