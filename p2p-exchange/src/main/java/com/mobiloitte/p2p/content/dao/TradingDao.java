...
public interface TradingDao extends JpaRepository<Trading, Long> {
	...
	List<Trading> findBypeerToPeerExchangeIdAndTradeStatus(Long peerToPeerExchangeId, TradeStatus pending);

	List<Trading> findBypeerToPeerExchangeIdAndTradeStatusAndStatusType(Long peerToPeerExchangeId, TradeStatus pending,
			StatusType pending2);

	List<Trading> findByPeerToPeerExchangeIdAndTradeStatusAndStatusType(Long peerToPeerExchangeId, TradeStatus pending,
			StatusType pending2);

	List<Trading> findTradingBypeerToPeerExchangeId(Long p2pId);

	List<Trading> findTradingBypeerToPeerExchangeId(Long p2pId, Pageable of);

	Optional<Trading> findByPeerToPeerExchangeIdAndTradeId(Long peerToPeerExchangeId, String tradeId);
