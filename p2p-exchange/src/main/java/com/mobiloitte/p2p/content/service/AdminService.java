...
public interface AdminService {
	...
	// Response<Object> assignStaffForDispute(Long userId, Long staffId, String
	// disputeId);
...
//	Response<Object> escrowList(Long userId, Integer page, Integer pageSize, StatusType statusType);

	Response<Object> escrowList(Long userId, Integer page, Integer pageSize, String tradingPartner,
