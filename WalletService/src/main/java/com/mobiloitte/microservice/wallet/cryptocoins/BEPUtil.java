...
public class BEPUtil implements CryptoCoinService, WalletConstants, OtherConstants {
	...
	public BigDecimal getBalanceAPIERCBEP(String walletAddress, String getContract) {
		try {
			...
			String apiBaseUri = "http://13.233.44.156:3029/bep20/getBalance?address=" + walletAddress + "&contract="
					+ getContract;
...
//					+ getContract;
	...
	public CryptoResponseModel internalTransferAPIBEPERC(CryptoRequestModel coinRequest, String getContract,
		...
		try {
			...
			String apiBaseUri = "http://13.233.44.156:3029/bep20/transferTokenUserToUser";
...
//			String apiBaseUri = apiUrl.getUSDT_API_BASE() + "transfer";
			String apiBaseUri = "http://13.233.44.156:3029/bep20/withdraw";
			String responseString = APIUtils.extractPostAPIData(apiBaseUri, USDT_TIMEOUT, entity);
			LOGGER.info(responseString);
			Map<String, Object> allData = APIUtils.getJavaObjectFromJsonString(responseString, Map.class);
			if (allData.containsKey("responseResult")) {
	...
	public CryptoResponseModel getAddressAPI(String account) {
		...
		try {
			...
			String apiBaseUri = "http://13.233.44.156:3029/bep20/generateAddress?mnemonic=" + mnemonic + "&count="
					+ account;
//			String apiBaseUri = "http://3.213.77.140:3029/bep20/generateAddress?mnemonic=" + mnemonic + "&count="
//					+ account;
