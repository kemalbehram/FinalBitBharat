package com.mobiloitte.content.model;
...
public class Constants {
	...
	public static final String BANNER_DATA_SAVED_SUCCESSFULLY = "Banner data saved successfully";
	
	public static final String BANNER_DATA_UPDATED_SUCCESSFULLY = "Banner data updated successfully";
	
	public static final String BANNER_DATA_EXISTS = "Already Banner Data exists, please update that";
	
	public static final String BANNER_DATA_FETCHED = "Banner Data fetched successfully";
	
	public static final String NO_DATA_FOUND = "No Data Found";
	
	public static final String WEBSITE_CONTENT_DATA_SAVED_SUCCESSFULLY = "Website content data saved successfully";
	
	public static final String WEBSITE_CONTENT_DATA_UPDATED_SUCCESSFULLY = "Website content data updated successfully";
	
	public static final String WEBSITE_CONTENT_DATA_EXISTS = "Already Website content Data exists, please update that";
	
	public static final String WEBSITE_CONTENT_DATA_FETCHED = "Website content Data fetched successfully";
}
